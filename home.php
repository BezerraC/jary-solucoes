            ...
            <div class="col d-inline-flex flex-sm-row flex-column">
                <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        ...
                        <img src="/img/racao1.jpeg" class="d-block" alt="..." height="350">
                        </div>
                        <div class="carousel-item">
                        <img src="/img/racao2.jpeg" class="d-block" alt="..." height="350">
                        </div>
                        <div class="carousel-item">
                        <img src="/img/racao3.jpeg" class="d-block" alt="..." height="350">
                        </div>
                    </div>
...
<section class="px-4 margin_sec">
    <div class="text-center">
        ...
        <p class="subtitle">Temos um time de excelência e competência </p>
    </div>
